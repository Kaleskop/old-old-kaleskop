<form method="POST" action="{{ route( 'password.email' ) }}">
 ...
 <button type="submit" class="appearance-none outline-none cursor-pointer select-none block w-full leading-snug py-1 px-2 border border-transparent bg-gray-400 text-lg font-semibold text-center focus:shadow-md">{{ __( 'Send password reset link' ) }}</button>
</form>
