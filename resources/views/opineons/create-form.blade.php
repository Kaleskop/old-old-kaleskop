<form method="POST" action="{{ route( 'advs.express', $adv ) }}">
 ...
 <div class="py-2 flex justify-between items-center">
  ...
  <button type="submit" class="appearance-none outline-none cursor-pointer select-none block leading-snug p-2 border border-transparent font-medium text-center focus:shadow-md">{{ __( 'Publish' ) }}</button>
 </div>
</form>
